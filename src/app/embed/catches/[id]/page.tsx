  ...
  return (
    <article className="flex flex-1 flex-col overflow-hidden rounded border border-teal-100 bg-white shadow-soft">
      ...
      <div className="relative bg-slate-100">
        {item.imageUrl ? (
          <img src={item.imageUrl} alt={item.fishType} className="h-[44svh] min-h-[245px] w-full object-cover" />
        ) : (
          <div className="flex h-[44svh] min-h-[245px] items-center justify-center text-sm font-bold text-slate-500">写真なし</div>
        )}
