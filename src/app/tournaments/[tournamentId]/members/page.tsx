    ...
    return (
      <>
        ...
        <main className="mx-auto max-w-xl px-4 py-5">
          <p className="rounded bg-white p-4 text-sm font-bold text-slate-700 shadow-soft">ownerまたはadminのみアクセスできます。</p>
        </main>
      </>
    );
  }
              ...
              <article key={participant.id} className="rounded border border-teal-100 bg-white p-4 shadow-soft">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <label className="block min-w-40">
                    <span className="text-xs font-black text-slate-600">role</span>
                    <select
                      disabled={locked}
                    ...
                    >
                      {participant.role === "owner" ? <option value="owner">owner</option> : null}
